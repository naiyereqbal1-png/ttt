    ...
    <div id="customer-profile-view" className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          {/* Android APK & Native App Setup Tab */}
          {((activeTab as string) === 'APK') && (
            <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-2xs space-y-6">
              <div className="border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-base font-black text-slate-900">Android Mobile Application Setup</h2>
                    <p className="text-xs text-slate-500">Choose your preferred method to run or install our mobile application</p>
                  </div>
                </div>
              </div>

              {/* Path 1: Instant Native-like App Installation (PWA) */}
              <div className="p-5 bg-gradient-to-r from-indigo-50 to-indigo-100/50 rounded-2xl border border-indigo-100 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider">
                      Method A: Instant Native Installation (PWA)
                    </h3>
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Install our Progressive Web App directly to your Android device in 5 seconds. It runs in full screen without a browser search bar, provides offline functionality, and shows up on your app drawer with a home icon!
                    </p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                  <div className="bg-white p-3.5 rounded-xl border border-indigo-100/50 text-xs">
                    <span className="font-bold text-slate-800 block mb-1">📱 Chrome for Android:</span>
                    <ol className="list-decimal pl-4 text-slate-600 space-y-1 text-[11px]">
                      <li>Open this store in Chrome browser.</li>
                      <li>Tap the <strong>three dots (Menu)</strong> icon.</li>
                      <li>Select <strong>"Install app"</strong> or <strong>"Add to Home screen"</strong>.</li>
                    </ol>
                  </div>
                  <div className="bg-white p-3.5 rounded-xl border border-indigo-100/50 text-xs">
                    <span className="font-bold text-slate-800 block mb-1">🌐 Other Mobile Browsers:</span>
                    <ol className="list-decimal pl-4 text-slate-600 space-y-1 text-[11px]">
                      <li>Open the browser options/share menu.</li>
                      <li>Tap <strong>"Add to Home Screen"</strong>.</li>
                      <li>Enjoy standard launcher integration!</li>
                    </ol>
                  </div>
                </div>
              </div>

              {/* Path 2: Download Native Kotlin Project for local compilation */}
              <div className="p-5 bg-amber-50/70 border border-amber-200 rounded-2xl space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-xs font-black text-amber-900 uppercase tracking-wider">
                      Method B: Native Android Project Codebase (.ZIP)
                    </h3>
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Download the complete native Android codebase written in <strong>Kotlin & Jetpack Compose</strong>. You can open this project in Android Studio on your PC to compile, preview, or build a custom signed APK file immediately!
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-amber-200/50 space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
                    <div>
                      <span className="font-bold text-slate-900 block">android_project.zip</span>
                      <span className="text-[11px] text-slate-500 font-mono">Size: ~25.4 MB • Includes Material 3, Coil & Compose UI</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <a
                        href="/android_project.zip"
                        download="TryAtHome_AndroidKotlin_Project.zip"
                        className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-lg text-xs transition-colors flex items-center gap-1.5 cursor-pointer shadow-xs"
                      >
                        <Download className="w-3.5 h-3.5" />
                        <span>Download ZIP</span>
                      </a>
                      <a
                        href="/android_project.tar.gz"
                        download="TryAtHome_AndroidKotlin_Project.tar.gz"
                        className="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg text-xs transition-colors cursor-pointer border border-slate-200"
                  ...
                  <div className="border-t border-slate-100 pt-3 text-[11px] text-slate-600">
                    <span className="font-bold text-slate-800 block mb-1">🛠️ How to Compile APK Locally in Android Studio:</span>
                    <ol className="list-decimal pl-4 space-y-1">
                      <li>Download and extract the <strong>ZIP</strong> file above.</li>
                      <li>Open <strong>Android Studio</strong> on your computer.</li>
                      <li>Select <strong>File &gt; Open...</strong> and choose the extracted folder.</li>
                      <li>Wait for Gradle sync to complete successfully.</li>
                      <li>Go to <strong>Build &gt; Build Bundle(s) / APK(s) &gt; Build APK(s)</strong>.</li>
                      <li>The compiled `.apk` will be saved on your disk ready for installation!</li>
                    </ol>
                  </div>
                </div>
              </div>

              {/* Path 3: Automated Free Online APK Compilation */}
              <div className="p-5 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-slate-700 text-white flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                    3
                  </span>
                  <div className="space-y-1">
                    <h3 className="text-xs font-black text-slate-900 uppercase tracking-wider">
                      Method C: Direct Cloud APK Compilation (No Android Studio required!)
                    </h3>
                    <p className="text-xs text-slate-600 leading-relaxed">
                      Want to build an APK right now without downloading or configuring code? You can use Microsoft's official free open-source tool, <strong>PWABuilder</strong>, which compiles PWAs into production-ready Android APKs in less than a minute!
                    </p>
                  </div>
                </div>

                <div className="bg-white p-4 rounded-xl border border-slate-200/70 space-y-3 text-xs text-slate-600">
                  <div className="flex items-center gap-2 text-indigo-700 font-bold">
                    <Info className="w-4 h-4 text-indigo-500" />
                    <span>Generate APK Online in 3 Steps:</span>
                  </div>
                  <ol className="list-decimal pl-4 space-y-1.5 text-[11px]">
                    <li>
                      Copy the current URL of this web application:
                      <div className="mt-1 flex items-center gap-2">
                        <input
                          type="text"
                          readOnly
                          value={window.location.origin}
                          className="px-2 py-1 bg-slate-50 border border-slate-200 rounded font-mono text-[10px] w-full text-indigo-600 font-bold focus:outline-hidden"
                          onClick={(e) => (e.target as HTMLInputElement).select()}
                        />
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText(window.location.origin);
                            alert("Copied successfully! Paste this in PWABuilder.");
                          }}
                          className="px-2.5 py-1 bg-indigo-50 text-indigo-700 rounded text-[10px] font-bold hover:bg-indigo-100 transition-colors"
                        >
                          Copy
                        </button>
                      </div>
                    ...
                    <li>
                      Go to <a href="https://www.pwabuilder.com" target="_blank" rel="noreferrer" className="text-indigo-600 font-bold underline hover:text-indigo-800 inline-flex items-center gap-0.5">
                        PWABuilder.com <ExternalLink className="w-3 h-3" />
                      </a>
                    </li>
                    <li>
                      Paste the URL you copied, click <strong>"Start"</strong>, and then select <strong>"Generate Android APK"</strong>. That's it! Your fully functional signed APK file will download instantly!
                    </li>
                  </ol>
                </div>
              </div>
